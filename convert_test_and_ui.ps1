# PowerShell Script to Convert test_and_ui_documentation.md to beautiful Word Document (DOCX) using Word COM Object Selection
# Standar Skripsi Indonesia: A4, Margin 4-3-3-3cm, Times New Roman 12pt, Spacing 1.5, Justified, Table Grid formal.

$mdPath = "d:\apk_edu\apk_edu\test_and_ui_documentation.md"
$docxPath = "d:\apk_edu\Hasil_Testing_dan_UI_EduConnect.docx"
...
Write-Host "Membaca dan memproses isi berkas..."
