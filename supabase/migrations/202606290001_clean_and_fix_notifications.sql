-- Fix infinite looping session end notifications and clean up existing duplicate notifications
...
-- Clean up any existing duplicate "Sesi Belajar Telah Berakhir" notifications, keeping only the latest one per user and session
delete from public.app_notifications a
using public.app_notifications b
where a.id < b.id
  and a.user_uid = b.user_uid
  and a.target_id = b.target_id
  and a.title = 'Sesi Belajar Telah Berakhir';
